    ...
    <Shader
      source={`
        ...
        void main() {
          ...
          opacity *= step(u_dot_size / u_total_size, fract(st.x / u_total_size));
          opacity *= step(u_dot_size / u_total_size, fract(st.y / u_total_size));

          vec3 color = u_colors[int(rand * 10.0)];
